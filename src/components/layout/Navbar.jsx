...
import { Menu, X, User, LogOut, ChevronDown, Zap, History } from 'lucide-react';
                  ...
                  >
                    ...
                    <div className="p-1">
                      <Link
                        ...
                        className="flex items-center gap-2 w-full px-3 py-2 text-sm text-foreground hover:bg-muted/50 rounded-lg transition-colors"
                      >
